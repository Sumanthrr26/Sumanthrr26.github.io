  ...
  return (
    <div id="home">
      <div className="left_container">
        ...
        >
          <h1 style={{ marginBottom: "-23px" }}>Sumanth U R</h1>
        </div>
        <div
          style={{
            marginTop: "-30px",
        ...
        >
          <a
            target="blank"
            href="https://www.linkedin.com/in/sumanth-u-r/"
            title="sumanth-u-r"
          >
          ...
          <a
            target="blank"
            href="https://github.com/Sumanthrr26"
            title="Sumanthrr26"
          >
      ...
      <div className="right_container">
        <div className="profile_container">
          <img className="home-img" src="Profile-1.png" alt="" />
        </div>
      </div>
    </div>
  );
