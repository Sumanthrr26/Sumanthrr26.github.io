      ...
      <div className="about_container">
        ...
        <div className="right_about" id="user-detail-intro">
          <div style={{ display: "flex", gap: "10px" }}>
            ...
            <div>
              Hello, My name is{" "}
              <span style={{ fontWeight: "600" }} id="user-detail-name">
                Sumanth U R
              </span>{" "}
              and I enjoy creating thing that live on the internet.
            </div>
          </div>
          <div style={{ display: "flex", gap: "10px" }}>
            <div>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            ...
            <div>
              ...
              with hands on experience in building React Apps. Works efficiently
              both in frontend (React.js) as well as backend (Node.js,
              Express.js, MongoDB) and proficient in Data Structure and
              Algorithms with good problem solving skills.
            </div>
          </div>
          <div style={{ display: "flex", gap: "10px" }}>
            <div>
