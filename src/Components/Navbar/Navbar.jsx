...
import myFile from "../../static/Sumanth-U-R-Resume.pdf";
...
function Navbar() {
  ...
  const downloadResume = () => {
    const previewUrl =
      "https://drive.google.com/file/d/1TzAefM4jszV5CQz2G5uSbok7FYHHvFgT/view?usp=sharing";
    const downloadUrl =
      "https://drive.google.com/uc?export=download&id=1TzAefM4jszV5CQz2G5uSbok7FYHHvFgT";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1>
            SUM<span style={{ color: "#4000ff" }}>ANTH</span>
          </h1>
        </Link>
      </div>
      {isMobile ? (
